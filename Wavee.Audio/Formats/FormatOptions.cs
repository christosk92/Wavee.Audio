...
/// If a <see cref="IFormatReader"/> requires a seek index, but the container does not provide one, build the
...
/// </param>
public record FormatOptions(bool PrebuildSeekIndex = false,
    ushort SeekIndexFillRate = 20,
    bool EnableGapless = false);